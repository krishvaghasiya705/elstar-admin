    ...
    items: [
      {
        ...
        details: [
          ...
          { name: "Scrum Board", path: "/scrum-board" },
          { name: "Issue", path: "" },
        ],
      },
      {
          ...
          {sidebarSections.map((section, sectionIdx) => (
            <div key={section.title}>
              <div className="mt-4 mb-2 px-3">
                <h1 className="text-sm font-semibold text-gray-500 select-none uppercase font-Roboto">
                  {section.title}
                </h1>
              </div>
              <div>
                    ...
                    <div key={item.label}>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-sm text-gray-600 font-semibold font-Roboto group-hover:text-black select-none transition-all duration-400 ease-in-out">
                            {item.label}
                          </p>
                        </div>
                        {hasDropdown && (
                      ...
                      {hasDropdown && (
                        ...
                        >
                          {item.details.map(({ name, path }) => {
                            ...
                            const content = (
                              <p
                                className={`text-sm font-semibold font-Roboto capitalize select-none transition-all duration-400 ease-in-out ${
                                  isActive
                                    ? "text-black"
